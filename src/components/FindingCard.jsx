...
export default function FindingCard({
 ...
 <span className="font-body text-[10px] text-takorin-ghost flex-shrink-0">
 Your response:
 </span>
 ...
 className="flex-1 text-[11px] font-body bg-takorin-stone text-takorin-muted px-2 py-1.5 border border-takorin-rule focus:outline-none focus:border-takorin-ochre"
 >
 ...
 <span className="font-body text-[10px] text-danger">
