...
export const platformBaseline = {
  ...
  metrics: [
    ...
    },
    {
      ...
      label: 'Off-peak energy cost — automated equipment scheduling',
      unit: '$/wk',
      unitLabel: 'HVAC + equipment off-peak shifting',
      before: 1860,
      after: 840,
      delta: -1020,
      direction: 'improvement',
      attribution: 0.69,
      annualValue: 53040,
      how: 'EnergyController shifts HVAC setpoints and equipment cycles into off-peak windows when zone conditions allow — a documented example reduced Zone B HVAC cost by $340 in one off-peak window (execution log, exec-005). Averaging ~3 qualifying windows/week × $340 × 52 weeks.',
      caveat: 'Off-peak window frequency varies with ambient conditions and production schedule — 3/week is a trailing average, not a guaranteed cadence. Utility rate assumptions are plant-specific.',
      sourceModule: 'Agents',
      sourceRoute: '/agents',
    },
    {
