...
export const handoffData = {
  ...
  cases: [
    ...
    { num:'IV.', urgency:'warn', title:'Carry-forward: Oven B temperature oscillation — pre-production inspection',
    ...
    { num:'V.', urgency:'danger', title:'URGENT: Filling machine pressure relief seal — maintenance flagged',
    ...
    { num:'VI.', urgency:'warn', title:'Carry-forward: Ingredient receiving dock — door latch repair pending',
    ...
    { num:'VII.', urgency:'ok', title:'Staff update — Martinez certification pathway',
      desc:'Martinez completed L1 Sauce Dosing. Recommend advancement to L2 after 3 more supervised shifts.' },
    { num:'VIII.', urgency:'danger', title:'URGENT: Allergen labeling discrepancy — trace peanut contamination risk',
    ...
    { num:'IX.', urgency:'warn', title:'Carry-forward: Utilities alert — water usage 12% above baseline',
    ...
    { num:'X.', urgency:'ok', title:'Next shift handoff — Adeyemi cert watch note',
