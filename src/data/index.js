...
export const handoffData = {
  ...
  cases: [
    ...
    { num:'R03.', urgency:'ok', title:'R-03 Seal Press A — bearing replaced, returned to service 23:48',
      desc:'Predictive Maintenance agent flagged bearing wear at 13:12 (vibration 3.4 mm/s, +62% from shift start). Director approved inspection window tonight 22:00–23:30. Bearing replaced, R-03 back online at 23:48 running at 0.9 mm/s. Production loss avoided: $8,200.',
      evidence:'Maintenance tech report filed 23:52. R-03 telemetry confirms vibration at 0.9 mm/s — within normal range. ImpactLoop: INT-2026-R03-01.',
      recommendedAction:'No action needed. R-03 is clear for AM shift. Monitor vibration at shift start as standard protocol.',
      agentSourced: true, agentId: 'maintenance', resolvedInShift: true },
