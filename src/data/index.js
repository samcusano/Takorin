...
export const handoffData = {
  ...
  cases: [
    ...
    { num:'R03.', urgency:'ok', title:'R-03 Seal Press A — bearing replaced, returned to service 23:48',
      ...
      evidence:'Maintenance tech report filed 23:52. R-03 telemetry confirms vibration at 0.9 mm/s — within normal range. Performance: INT-2026-R03-01.',
...
export const capaData = {
  cases: [
    { id:'CAPA-2604-001', urgency:'danger', num:'!', title:'Line 4 Conveyor Bearing Failure — Sensor A-7 threshold breach',
      sub:'Overdue · 7 days · auto-created from Shift', status:'Overdue', statusTone:'danger',
    ...
    { id:'CAPA-2604-007', urgency:'warn', num:'III.', title:'Supplier COA rejection — Tomato Sauce Lot TS-8811, ConAgra',
      sub:'Open · auto-created from Suppliers', status:'In progress', statusTone:'warn',
